...
\def\mybibliocommand{}
\def\mysubtitle{}
\def\myaffiliation{Universidad Santo Tomas}
\def\myaddress{Facultad de Estadistica}
\def\myemail{carloslesmes@gmail.com}
\def\myweb{}
\def\myphone{(571) 3153506995}
\def\myfax{(571) 8039809}
\def\mytwitter{@carloslesmes3}
\def\myversion{}
\def\myrevision{}


\def\myaffiliation{Carlos Lesmes}
\def\myauthor{Carlos Lesmes}
\date{} % not used (revision control instead)
\def\mykeywords{Carlos, Lesmes, Carlos Lesmes, CV, Resume, Statistcs}
